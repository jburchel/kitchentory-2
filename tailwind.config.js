  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Primary - Emerald Brand System (#10B981)
        primary: {
          ...
          500: "#10B981",  // PRIMARY BRAND COLOR - Emerald 600 (brandbook compliant)
  ...
  plugins: [
    ...
    function({ addUtilities }) {
      const newUtilities = {
        ...
        // Touch targets (44x44px minimum) - WCAG AA Compliance
        '.touch-target': {
          minHeight: '44px',
          minWidth: '44px',
        },
        '.touch-target-sm': {
          minHeight: '44px',
          minWidth: 'auto',
          padding: '10px 16px', // Ensures 44px with content
